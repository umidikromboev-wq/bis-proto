...
/**
 * Симулятор потерь без единой системы.
 * Формулы и константы перенесены 1:1 из проверенного bis-loss-simulator.html.
 * Дизайн — монохром прототипа (сайт обещает «здесь нет цвета — только смыслы»),
 * семантические цвета: потеря — акцент, возврат — зелёный.
 */
...
export function SimulatorView() {
  ...
  return (
    <div className="sim sim-page">
      <Breadcrumbs items={[{ label: "Главная", href: "/" }, { label: "Симулятор потерь" }]} />
        ...
        <div className="wrap">
          ...
          <div className="sim-grid" style={{ marginTop: "2rem" }}>
            ...
            <div className="sim-result">
              ...
              <button className="btn btn-solid" style={{ width: "100%", marginBottom: "0.6rem" }} onClick={() => show("lead")}>Точный расчёт от консультанта</button>
          ...
          <p className="note" style={{ marginTop: "0.75rem" }}>
            Коэффициенты — средние по проектам BIS до внедрения. Точный расчёт консультант делает на ваших данных.
          </p>
        </div>
      </section>
      ...
      <div className="msticky">
        ...
        <button className="btn btn-solid" style={{ padding: "0.7rem 1rem", flex: "none" }} onClick={() => show("lead")}>Точный расчёт</button>
      </div>
    </div>
  );
}
