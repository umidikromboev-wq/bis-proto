...
const RU = {
  ...
  // Подписи, найденные проверкой на кириллицу в собранных страницах
  fsHint: "Нажмите на точки — что меняется после внедрения",
  fsLoad: "загрузка оборудования",
  fsDowntime: "простои производства",
  fsAdminCost: "затраты на управление",
  fsSalesGrowth: "рост продаж",
  caseWasKicker: "Что было",
  caseWasH2: "С чем компания пришла",
  caseAboutKicker: "О компании",
  caseAboutH2: "Масштаб и отрасль",
  caseNowKicker: "Что стало",
  caseNowH2: "Результат после запуска",
  moreCasesKicker: "Ещё кейсы",
  moreCasesH2: "Другие внедрения",
  readMoreKicker: "Читать дальше",
  readMoreH2: "Другие разборы",
  academyCrumb: "SAP Академия",
  openPositionsKicker: "Открытые позиции",
  openPositionsH2: "Кого мы ищем сейчас",
  writeTo: "Написать на",
  productCasesKicker: "Кейсы",
  productCasesH2: "Внедрения этого продукта",
  questionsKicker: "Вопросы",
  questionsAbout: "Что спрашивают про",
  auditOneMeeting: "За одну встречу покажем, где вы теряете деньги сейчас, и как это закрывает",
  auditWritten: "Письменное заключение остаётся у вас в любом случае.",
  costExactNote: "Точную сумму заочно не назовёт никто: она зависит от оборота, отрасли и состояния учёта. Калькулятор покажет порядок за три минуты.",
  clientIndustry: "Отрасль клиента",
  allCases: "Смотреть все кейсы внедрения",
  teamMarquee: "Команда BIS",
  flowBefore: "Раньше",
  flowInSap: "В SAP",
  download: "Скачать",
  oldPrefix: "Раньше:",
...
const UZ: typeof RU = {
  ...
  fsHint: "Nuqtalarni bosing — joriy etishdan keyin nima oʻzgaradi",
  fsLoad: "uskunalar yuklanishi",
  fsDowntime: "ishlab chiqarish toʻxtashi",
  fsAdminCost: "boshqaruv xarajatlari",
  fsSalesGrowth: "sotuv oʻsishi",
  caseWasKicker: "Nima boʻlgan",
  caseWasH2: "Kompaniya nima bilan kelgan",
  caseAboutKicker: "Kompaniya haqida",
  caseAboutH2: "Miqyos va tarmoq",
  caseNowKicker: "Nima boʻldi",
  caseNowH2: "Ishga tushgandan keyingi natija",
  moreCasesKicker: "Yana loyihalar",
  moreCasesH2: "Boshqa joriy etishlar",
  readMoreKicker: "Davomini oʻqish",
  readMoreH2: "Boshqa tahlillar",
  academyCrumb: "SAP Akademiya",
  openPositionsKicker: "Ochiq lavozimlar",
  openPositionsH2: "Hozir kimni izlayapmiz",
  writeTo: "Yozish:",
  productCasesKicker: "Loyihalar",
  productCasesH2: "Bu mahsulotning joriy etilishi",
  questionsKicker: "Savollar",
  questionsAbout: "Nima soʻraladi:",
  auditOneMeeting: "Bitta uchrashuvda hozir qayerda pul yoʻqotayotganingizni va buni nima yopishini koʻrsatamiz:",
  auditWritten: "Yozma xulosa har qanday holatda sizda qoladi.",
  costExactNote: "Aniq summani masofadan hech kim aytmaydi: u aylanma, tarmoq va hisob holatiga bogʻliq. Kalkulyator uch daqiqada tartibni koʻrsatadi.",
  clientIndustry: "Mijoz tarmogʻi",
  allCases: "Barcha joriy etish loyihalarini koʻrish",
  teamMarquee: "BIS jamoasi",
  flowBefore: "Ilgari",
  flowInSap: "SAP da",
