...
export const importedPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "ERP integratsiya sotuv, ombor va moliya jarayonlarini yagona tizimga birlashtiradi. Biznesni tizimlashtirish va boshqaruvni avtomatlashtirish imkoniyatlarini biling.",
