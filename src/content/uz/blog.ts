...
const ownPosts: BlogPost[] = [
  {
    ...
    body: [
      { type: "p", text: "Soʻnggi yillarda joriy etishga urinish allaqachon boʻlgan — baʼzida ikkinchi marta — kompaniyalarga kirdik. Bu hikoyalarda dastur deyarli har doim normal boʻlgan. Hammasi bir xil oltita joyda buzilardi." },
      ...
      { type: "p", text: "Nomenklatura takrorlari, uch xil yozilgan kontragentlar, eski tizimda ham toʻgʻri kelmagan qoldiqlar. Bularning bari yangi tizimga koʻchadi va u yerda yangi tizim yomon ishlayotganining «dalili»ga aylanadi. Maʼlumotlarni tozalash — loyiha budjetining 10–15%, va uni oʻtkazib boʻlmaydi." },
      ...
      { type: "p", text: "Moliya, ombor, ishlab chiqarish, CRM va servis bir vaqtda. Jamoa bitta ham konturni oʻzlashtirishga ulgurmaydi, bir moduldagi xatolar boshqasidagi muammolar bilan izohlanadi, muddatlar esa loyiha kompaniya ichida qoʻllab-quvvatlashni yoʻqotadigan darajada surilib ketadi." },
  ...
  },
  {
    ...
    body: [
      { type: "p", text: "«SAP yoki 1C» savolini deyarli har bir birinchi uchrashuvda beradilar. Unga «qaysi biri yaxshi» formatida javob berish maʼnosiz: tizimlar turli vazifalarni hal qiladi va kompaniyada koʻpincha bir vaqtda ishlaydi." },
      ...
      { type: "list", items: [
        "Oyiga oʻrtacha emas, har bir ishlab chiqarish buyurtmasi boʻyicha faktik tannarx",
      ...
      { type: "p", text: "Koʻpincha ishlaydigan sxema shunday koʻrinadi: boshqaruv, ishlab chiqarish va ombor SAPga oʻtadi, rasmiy hisob 1C da qoladi, tizimlar orasida almashinuv sozlanadi. Maʼlumot ikki marta kiritilmaydi, har bir tizim esa oʻzi kuchli boʻlgan ishni qiladi." },
  ...
  },
  {
    ...
    author: "Zairov Sardorjon, SAP Business One loyihalari rahbari",
    body: [
      { type: "p", text: "Biznes egalari odatda bitta raqamni soʻraydi: «SAP qanchaga tushadi». Bitta raqam mavjud emas, ammo har qanday taklifni — bizningkini ham — tekshirish mumkin boʻlgan tushunarli tuzilma mavjud." },
      ...
      { type: "p", text: "Tekshiruv, sozlash, sinov, ishga tushirish. Budjetning asosiy qismi va pudratchilar bir necha barobar farq qiladigan yagona modda. Arzon taklif odatda hajmdan tekshiruv va sinov olib tashlangani degani." },
      ...
      { type: "p", text: "Ikkinchi «esdan chiqadigan» modda. Rollar boʻyicha oʻqitish tizimni oʻzlashtirish vaqtini qariyb uchdan birga qisqartiradi. U qisqartirilganda pul baribir sarflanadi — faqat keyinroq va Excelda parallel hisob shaklida." },
      ...
      { type: "p", text: "«Xodimlarda tejash»ni emas, harakatsiz tovarda muzlagan pulni, haqiqiy tannarxdan past sotilgan bitimlarni va aytilmagan muddat sababli qoʻldan ketgan buyurtmalarni hisoblang. Biz ishlagan kompaniyalarda samaraning asosiy qismini aynan shu uch modda bergan." },
