...
export default function Page() {
  return (
    <>
      <ServiceJsonLd locale="ru" name={productS4.title} description={productS4.metaDescription} path="/sap-s-4hana" />
...
export const metadata: Metadata = pageMetadata("ru", "/sap-s-4hana");
