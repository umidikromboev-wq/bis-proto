...
export default function Page() {
  return (
    <>
      <ServiceJsonLd locale="uz" name={productS4.title} description={productS4.metaDescription} path="/sap-s-4hana" />
...
export const metadata: Metadata = pageMetadata("uz", "/sap-s-4hana");
